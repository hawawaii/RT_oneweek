...
int main() {
    ...
    //world.add(make_shared<quad>(point3(-0.5, 0.5, 0.0), vec3(-1.0, 0.0, 0.0), vec3(0.0, -1.0, 0.0), material_metal01));
    //world.add(make_shared<quad>(point3(-0.5, 0.5, 0.0), vec3(-1.0, 0.0, 0.0), vec3(0.0, 0.0, -1.0), material_metal01));
    //world.add(make_shared<quad>(point3(-0.5, 0.5, 0.0), vec3(0.0, -1.0, 0.0), vec3(0.0, 0.0, -1.0), material_metal01));
